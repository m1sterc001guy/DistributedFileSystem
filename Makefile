CXX = g++
CPPFLAGS += -I/usr/local/include -pthread -D_FILE_OFFSET_BITS=64
CXXFLAGS += -std=c++11
LDFLAGS += -L/usr/local/lib -lgrpc++_unsecure -lgrpc -lgpr -lprotobuf -lpthread -ldl `pkg-config fuse --cflags --libs`
PROTOC = protoc
